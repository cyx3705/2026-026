...
internal partial class ShellWindow
{
    ...
    ///
    /// 界面自带的动作走 <see cref="Components.Actions.ActionRegistry.DeclareLocal"/> 而不是
    ...
    private void DeclareHostedPageActions()
    {
        _actions.DeclareLocal(
            HostedPages.Views.ComponentGalleryCommands.Owner,
            HostedPages.Views.ComponentGalleryCommands.Actions);
        _actions.DeclareLocal(
            HostedPages.Views.HostedPageDescriptions.Owner,
            HostedPages.Views.HostedPageData.Actions);
    }
}
