...
public sealed partial class PanelView : UserControl
{
    ...
    /// <summary>aurora.ui.panelreload:按新声明原地重建内容(P-08)。</summary>
    ...
    /// <summary>aurora.ui.panelset 反向驱动(P-07):程序向面板控件回写值。</summary>
    ...
    private void BuildControl(Grid grid, int row, PanelControl c)
    {
            ...
            case "button":
                {
                    ...
                    if (c.Style == "danger")
                    {
                        ...
                        button.SetResourceReference(ForegroundProperty, "Aurora.Brush.Danger");
                    }
            ...
            case "label":
                {
                    ...
                    text.SetResourceReference(ForegroundProperty, "Aurora.Brush.TextSecondary");
                    if (c.Id != null)
                    {
            ...
            case "slider":
                {
                    ...
                    valueText.SetResourceReference(ForegroundProperty, "Aurora.Brush.TextSecondary");
            ...
            case "dir":
                {
                    ...
                    {
                        var command = isDir ? "aurora.ui.selectdirectory" : "aurora.ui.selectfile";
        ...
        label.SetResourceReference(ForegroundProperty, "Aurora.Brush.TextPrimary");
