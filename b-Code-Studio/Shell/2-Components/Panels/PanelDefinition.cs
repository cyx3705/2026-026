...
public sealed class PanelWidget
{
    ...
    /// <see cref="HistoryAurora.Shell.Components.Widgets.AuroraPanelBoard.DefaultInputMinWidth"/> 算。
    /// 写了就以写的为准。
    /// </summary>
    ...
    /// （REQ-UI-041，见 <see cref="HistoryAurora.Shell.Components.Selection.SelectionChannels"/>）。
    ///
