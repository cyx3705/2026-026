...
internal static partial class BuiltinCommands
{
    private static void RegisterPanel(CommandRegistry r, ShellCommandServices s, PanelManager panels)
    {
        ...
        RegisterFrontend(r, new CommandDescriptor
        {
            Name = "aurora.ui.selectdirectory",
            Domain = "aurora",
            CommandClass = "ui",
            Summary = "选择本地目录",
            RequiresUiThread = true,
        ...
        RegisterFrontend(r, new CommandDescriptor
        {
            Name = "aurora.ui.panelshow",
            Domain = "aurora",
            CommandClass = "ui",
            Summary = "显示控制面板(等价 aurora.ui.show)",
            Example = "aurora.ui.panelshow id=my-panel",
            RequiresUiThread = true,
            Parameters =
            [
                new ParameterSpec { Name = "id", Description = "面板 id(aurora.ui.panels 可查)", Required = true, Position = 0 },
            ],
        ...
        RegisterFrontend(r, new CommandDescriptor
        {
            Name = "aurora.ui.panelset",
            Domain = "aurora",
            CommandClass = "ui",
            Summary = "程序向面板控件回写值(P-07)",
            Example = "aurora.ui.panelset panel=my-panel control=speed value=800",
            RequiresUiThread = true,
            Parameters =
            [
